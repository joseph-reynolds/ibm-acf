...
namespace CeLogin
{
    ...
    struct CeLoginRc
    {
        ...
        : mComponent(0 == reasonParm ? 0 : componentParm)
        , mReason(reasonParm)
        , mRsvd0(0)
        , mRsvd1(0)
        {
        ...
        {
            // Format manually to allow for consistant behavior on Big vs Little Endian systems
            return (uint64_t)mComponent << 56
                    | (uint64_t)mReason;
        }
    ...
    CeLoginRc getServiceAuthorityV1(const uint8_t* accessControlFileParm, const uint64_t accessControlFileLengthParm,
