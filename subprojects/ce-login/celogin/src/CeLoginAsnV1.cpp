...
namespace CeLogin
{
    ASN1_SEQUENCE(CELoginSequenceAlgorithmV1) = {
        ...
        ASN1_SIMPLE(CELoginSequenceAlgorithmV1, nullValue, ASN1_NULL)
    } ASN1_SEQUENCE_END(CELoginSequenceAlgorithmV1)
    ...
    ASN1_SEQUENCE(CELoginSequenceV1) = {
        ...
        ASN1_SIMPLE(CELoginSequenceV1, signature, ASN1_BIT_STRING)
    } ASN1_SEQUENCE_END(CELoginSequenceV1)
