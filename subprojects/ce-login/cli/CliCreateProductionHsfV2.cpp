...
void parseArgs(int argc, char** argv, struct Arguments& args)
{
    ...
    while (1)
    {
        ...
        else if (c == long_options[ScriptFile].val)
        {
...
CeLoginRc cli::createProductionHsfV2(int argc, char** argv)
{
    ...
    else if (sOperation == CreateJsonAndDigest)
    {
        ...
        if (CeLoginRc::Success == sRc)
        {
            ...
            sCreateHsfArgsV1.mPasswordHashAlgorithm =
    ...
    else if (sOperation == PackageJsonAndSignature)
    {
        ...
        sCreateHsfArgsV1.mSourceFileName =
        ...
        else
        {
            ...
            sRc = CeLogin::createCeLoginAcfV2Asn1(sCreateHsfArgsV2, sJsonStr,
                                                  sSignature, sAcf);
        }
